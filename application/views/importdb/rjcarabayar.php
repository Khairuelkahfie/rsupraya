...
<div class="container-fluid">
    <!-- Page Heading -->
    <h3 class="h3 mb-4 text-gray-800">Import Tabel Pembayaran Rawat Jalan</h3>
    <div class="row">
        <div class="col-md">
                    ...
                    <div class="card-body ">
                        <div class="row justify-content-center">
                            <div class="col-md-8">
                                ...
                                <form action="<?= base_url('importdb/importrjcarabayar') ?>" method="POST" enctype="multipart/form-data">
                                    <div class="row mb-2">
                                        <div class="col-md">
                                            <input type="file" name="file" id="file" class="" accept=".xlsx">
                                        </div>
                                        <div class="col-md">
